...
wget -q -O /usr/bin/trialvless "https://raw.githubusercontent.com/Genome26/lts2/main/menu/trialtrojan.sh" && chmod +x /usr/bin/trialtrojan
wget -q -O /usr/bin/trialtrojan "https://raw.githubusercontent.com/Genome26/lts2/main/menu/trialvless.sh" && chmod +x /usr/bin/trialvless
...
wget -q -O /usr/bin/atur-backup "https://raw.githubusercontent.com/Genome26/lts2/main/menu/atur-backup" && chmod +x /usr/bin/atur-backup
wget -q -O /usr/bin/online-xray "https://raw.githubusercontent.com/Genome26/lts2/main/menu/online-xray" && chmod +x /usr/bin/online-xray
wget -q -O /usr/bin/backup "https://raw.githubusercontent.com/Genome26/lts2/main/menu/backup" && chmod +x /usr/bin/backup
wget -q -O /usr/bin/restore "https://raw.githubusercontent.com/Genome26/lts2/main/menu/restore" && chmod +x /usr/bin/restore
wget -q -O /usr/bin/admin "https://raw.githubusercontent.com/Genome26/lts2/main/menu/admin" && chmod +x /usr/bin/admin
wget -q -O /usr/bin/online-vmess "https://raw.githubusercontent.com/Genome26/lts2/main/menu/online-vmess" && chmod +x /usr/bin/online-vmess
wget -q -O /usr/bin/online-vless "https://raw.githubusercontent.com/Genome26/lts2/main/menu/online-vless" && chmod +x /usr/bin/online-vless
wget -q -O /usr/bin/online-trojan "https://raw.githubusercontent.com/Genome26/lts2/main/menu/online-trojan" && chmod +x /usr/bin/online-trojan
wget -q -O /usr/bin/online-sshws "https://raw.githubusercontent.com/Genome26/lts2/main/online-sshws" && chmod +x /usr/bin/online-sshws
wget -q -O /usr/bin/update-usage "https://raw.githubusercontent.com/Genome26/lts2/main/menu/update-usage" && chmod +x /usr/bin/update-usage
wget -q -O /usr/bin/update-ssh-usage "https://raw.githubusercontent.com/Genome26/lts2/main/menu/update-ssh-usage.sh" && chmod +x /usr/bin/update-ssh-usage
