...
clear
source /etc/julak/token.json
if [ -f "/etc/julak/token.json" ]; then
rm -rf /root/backup
mkdir /root/backup
...
cp -r /etc/julak.txt /root/backup/julak &> /dev/null
cd /root
...
echo -e " ${TEAL}━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━${NC}"
echo -e " ${ORANGE}  🍀 POWERED BY @Julak_Bantur 🍀  ${NC}"
echo -e " ${TEAL}━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━${NC}"
echo -e " ${TEAL}━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━${NC}" 
...
echo -e " ${PURPLE}  Script Credit By  Julak Bantur Autoscript${NC}"
echo -e " ${TEAL}━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━${NC}"
exit 0
fi
echo -e "${TEAL}━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━${NC}"
...
enable_crontab() {
    ...
    if [[ "$enable_crontab" =~ ^[Yy]$ ]]; then
        (crontab -l 2>/dev/null; echo "0 */23 * * * /usr/bin/julak-manual-backup") | crontab -
