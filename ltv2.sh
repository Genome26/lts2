...
echo "cyan" > /etc/julak/theme/color.conf
...
wget https://raw.githubusercontent.com/rajaganjil93/ccc/main/TOOLS/tools.sh -O tools.sh &> /dev/null
chmod +x tools.sh
bash tools.sh
start=$(date +%s)
...
echo -e "\e[1;31m⚠️ Reboot sekali biar ga error cuyy \e[0m"
echo -e "❏━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━❏"
