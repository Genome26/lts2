...
wget -O /usr/local/bin/ws-dropbear https://raw.githubusercontent.com/Genome26/lts2/main/WEBSOCKET/ws-dropbear
...
wget -O /usr/local/bin/ws-ovpn https://raw.githubusercontent.com/Genome26/lts2/main/WEBSOCKET/ws-ovpn.py
...
wget -O /usr/local/bin/ws-stunnel https://raw.githubusercontent.com/Genome26/lts2/main/WEBSOCKET/ws-stunnel
