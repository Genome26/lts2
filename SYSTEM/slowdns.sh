...
wget -q -O /etc/slowdns/server.key "https://github.com/cibut2d/lts2/main/SLOWDNS/server.key"
wget -q -O /etc/slowdns/server.pub "https://github.com/cibut2d/lts2/main/SLOWDNS/server.pub"
wget -q -O /etc/slowdns/sldns-server "https://github.com/cibut2d/lts2/main/SLOWDNS/dnstt-server"
wget -q -O /etc/slowdns/sldns-client "https://github.com/cibut2d/lts2/main/SLOWDNS/dnstt-client"
cd
